...
仿真完成后，结果将存储在案例文件夹中，其中有一个名为 `results` 的子文件夹。运行 `v2sim-gui` 或 `v2simux-gui` 启动界面并选择您刚刚仿真的案例。然后点击 `查看结果`，将弹出一个新窗口显示结果。它看起来会像这样：
...
**比较两个结果：** 在启动界面中，选择“工具”菜单的“结果比较器...”，可以在同一页面显示两个结果，这使您更容易识别差异。就像下图所示：
