...
+ [**V2Sim-UX**](https://github.com/hesl-seu/h2sim/tree/uxsim)：使用 UXsim 进行**中观**交通仿真。它使用自由线程 Python (3.14+) **运行非常快**。如果您的研究需要快速迭代并关注交通流的整体影响，此版本是合适的。代码链接：https://github.com/hesl-seu/h2sim/tree/uxsim
