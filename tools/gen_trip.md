...
+ **mode**: by which to generate the trips. There are 3 modes, which is described in [genveh page](usage/2_4_genveh). Default: `auto`.
+ **cache-route**: how to store the routing cache, which is described in [genveh page](usage/2_4_genveh). Default: `none`.
